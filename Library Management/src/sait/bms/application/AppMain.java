...
/**
 * AppMain - This is the main class that calls the Arraylist from the
 * loadLibrary method from the Library Management Class. The main class has a
 * switch case that loads all methods that the user chooses. These options are
 * checkout, find book by title, find books by type, produce random book and
 * save & exit.
 * 
...
public class AppMain {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 5. Case 1: checks out a book from the books.txt list Case 2: finds all the
		 * book titles that the user inputs Case 3: finds all the books by there type
		 * from the user input through an input. Case 4: shows random number of books
		 * base the the number the user inputs. Case 5: Saves to the books.txt and exits
		 * Default: This is when the user give an invalid input for a choice, a message
		 * would pop up that says invalid option.
		 */
		int x = 0;
		while (x != 5) {
