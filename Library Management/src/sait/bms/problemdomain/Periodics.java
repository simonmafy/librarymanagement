...
/**
 * The Periodics has all the assessor and mutators. It also has helps creates the objects while
...
public class Periodics extends Book {
	...
	public Periodics (long getISBN, String getCall, int getAvailable, int getTotal, String getTitle, String getFrequency) {
	 ...
	 * 
	 * @return format (ISBN + ";" + call + ";" + available + ";" + total + ";" + title + ";" + frequency + "\n")
	 */
