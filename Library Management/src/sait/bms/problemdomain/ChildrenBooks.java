...
/**
 * The ChildrenBooks class has all the assessor and mutators. It also has helps creates the objects while
...
public class ChildrenBooks extends Book{
	 ...
	 * @param getFormat
	 */
	public ChildrenBooks(long getISBN, String getCall, int getAvailable, int getTotal, String getTitle, String getAuthor, String getFormat) {
	 ...
	 * 
	 * @return format (ISBN + ";" + call + ";" + available + ";" + total + ";" + title + ";" + author + ";" + format + "\n")
	 */
	public String toPrintFormat() {
		return String.format(ISBN + ";" + call + ";" + available + ";" + total + ";" + title + ";" + author + ";" + format + "\n");
	}
