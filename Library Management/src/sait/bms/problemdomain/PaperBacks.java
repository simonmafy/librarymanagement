...
/**
 * The PaperBacks has all the assessor and mutators. It also has helps creates
...
public class PaperBacks extends Book {
	...
	public PaperBacks(long getISBN, String getCall, int getAvailable, int getTotal, String getTitle, String getAuthor,
			String getYear, String getGenre) {
	...
	public String toPrintFormat() {
		return String.format(ISBN + ";" + call + ";" + available + ";" + total + ";" + title + ";" + author + ";" + year
				+ ";" + genre + "\n");
	}
